...
11. **FT4 タブ実装（v0.3.0 目標）** — 設計確定済み。ft8_lib（C ライブラリ）コーデック・リグサウンドカード必須・QSO ステートマシン（詳細は「FT4 機能設計」セクション参照）
...
File / Satellite / Radio / Communications / Autotrack/Record / View / Help
                              ...
                              └── FT4         （v0.3.0 目標・設計確定済み）
```

---

### SSTV / SSDV 機能設計（v0.3.0 目標）
...
### FT4 機能設計（v0.3.0 目標・2026-06-13 設計確定）
...
- 開発環境: システムの `libft8.so` を ctypes で使用
